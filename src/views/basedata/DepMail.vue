  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-select v-model="query.enabled" clearable size="small" placeholder="部门" class="filter-item" style="width: 120px">
          <!-- @change="crud.toQuery"> -->
          <el-option v-for="item in deps" :key="item.key" :label="item.display_name" :value="item.key" />
        </el-select>
        <rrOperation />
      </div>
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" highlight-current-row style="width: 100%" @selection-change="crud.selectionChangeHandler" @current-change="handleCurrentChange">
      ...
      <el-table-column prop="mail" label="邮件地址" />
...
export default {
  ...
  cruds() {
    return CRUD({ title: '邮件信息', url: 'api/depmail', crudMethod: { ...crudSync }})
  },
  ...
  data() {
    return {
      ...
      deps: [
        { key: 'dep1', display_name: '生产部' },
        { key: 'dep2', display_name: '物流部' },
        { key: 'dep3', display_name: '开发部' },
        { key: 'dep4', display_name: '工艺部' }
      ],
      name: 'app',
      currentRow: null,
      permission: {
